...
public class Modalities extends Application {

    @Override
    public void start(final Stage primaryStage) {
        primaryStage.setTitle("Modality");
        ...
        Stage dialogoModality = new MyDialog(primaryStage);
        dialogoModality.sizeToScene();
        dialogoModality.show();
